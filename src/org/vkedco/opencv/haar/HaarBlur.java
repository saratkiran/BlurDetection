...
public class HaarBlur {
	...
	static void estimateImageBlur(Mat mat, double haar_thresh, double min_zero_thresh) {
		computeEmaps(mat);
		computeEmaxes();
	...
	static boolean getIsBlurred() { return mIsBlurred; }
	static double getBlurExtent() { return mBLUR_EXTENT; }
